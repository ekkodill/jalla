...
<div id="page">
  ...
  <h1>Sorry, du må være innlogget for å se denne siden.</h1> 
    <p>Send epost for forespørsel om registrering eller logg inn. 
    	<?php  print_r(user_data($_SESSION['brukerPK'])); ?>	
    </p>
