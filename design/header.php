...
<header>
		<?php if(logged_in() === true) { echo "<h3 class='loggetInnSom'><a href='minside.php'>".$user_data['fornavn'] ." ". $user_data['etternavn']."</a><a href='brukerforside.php'>(".ubesvarteOppg($user_data['brukerPK'])->num_rows.")</a></h3>"; } ?> 
